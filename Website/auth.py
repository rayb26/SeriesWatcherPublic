...
# The following code was commented in production since we have not deployed our login service at this time. 
...
def sign_up():
    if request.method == 'POST':
        ...
        if user:
            ...
            flash('Password must be larger than 7 characters', category='error')
